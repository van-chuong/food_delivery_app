                        ...
                        children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          RatingBarIndicator(
                                            rating: favoriteController.favoriteProducts[index].rating,
                          ...
                          Positioned(
                              ...
                              child: Obx(()=>IconButton(
                                icon: Icon(
                                  favoriteController.isFavorite(favoriteController.favoriteProducts[index].id)?Icons.favorite:Icons.favorite_border,
                                  color: Colors.red,
                                ),
                                onPressed: (){
                                  if(FirebaseAuth.instance.currentUser != null){
                                    if(favoriteController.isFavorite(favoriteController.favoriteProducts[index].id)) {
                                      favoriteController.removeFavorite(favoriteController.favoriteProducts[index].id);
                                      showTopSnackBar(
                                        Overlay.of(context),
